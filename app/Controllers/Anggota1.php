...
class Anggota extends BaseController
{
	...
	public function verified_all()
	{
		$data = [
			...
			'total_kota' => $this->Modelanggota->data_verified_kota(),
			'total_bantul' => $this->Modelanggota->data_verified_bantul(),
			'total_sleman' => $this->Modelanggota->data_verified_sleman(),
			'total_gk' => $this->Modelanggota->data_verified_gk(),
		];
		return view('admin/v_verified_all', $data);
	}
	//melihat data anggota dpc kota yang telah terverifikasi
	public function verified_kota()
	{
		$data = [
			'title' => 'Data Telah Di Verifikasi',
			'subtitle' => 'Anggota',
			//'dpc' => $this->ModelDpc->getalldata(),
			'anggota' => $this->Modelanggota->verifiedkota(),
		];
		return view('admin/v_verified_kota', $data);
	}
	public function verified_bantul()
	{
		$data = [
			'title' => 'Data Telah Di Verifikasi',
			'subtitle' => 'Anggota',
			//'dpc' => $this->ModelDpc->getalldata(),
			'anggota' => $this->Modelanggota->verifiedbantul(),
		];
		return view('admin/v_verified_bantul', $data);
	}
	public function verified_kp()
	{
		$data = [
			'title' => 'Data Telah Di Verifikasi',
			'subtitle' => 'Anggota',
			//'dpc' => $this->ModelDpc->getalldata(),
			'anggota' => $this->Modelanggota->verifiedkp(),
		];
		return view('admin/v_verified_kp', $data);
	}
	public function verified_sleman()
	{
		$data = [
			'title' => 'Data Telah Di Verifikasi',
			'subtitle' => 'Anggota',
			//'dpc' => $this->ModelDpc->getalldata(),
			'anggota' => $this->Modelanggota->verifiedsleman(),
		];
		return view('admin/v_verified_sleman', $data);
	}
	public function verified_gk()
	{
		$data = [
			'title' => 'Data Telah Di Verifikasi',
			'subtitle' => 'Anggota',
			//'dpc' => $this->ModelDpc->getalldata(),
			'anggota' => $this->Modelanggota->verifiedgk(),
		];
		return view('admin/v_verified_gk', $data);
	}
